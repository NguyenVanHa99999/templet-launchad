...
export interface ApiBannerLoopBannerLoop extends Struct.CollectionTypeSchema {
  collectionName: 'banner_loops';
  info: {
    displayName: 'Banner-Loop';
    pluralName: 'banner-loops';
    singularName: 'banner-loop';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiThapVanPhongThapVanPhong
  extends Struct.CollectionTypeSchema {
  collectionName: 'thap_van_phongs';
  info: {
    displayName: 'thap-van-phong';
    pluralName: 'thap-van-phongs';
    singularName: 'thap-van-phong';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::thap-van-phong.thap-van-phong'
    >;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::banner-loop.banner-loop': ApiBannerLoopBannerLoop;
      ...
      'api::thap-van-phong.thap-van-phong': ApiThapVanPhongThapVanPhong;
